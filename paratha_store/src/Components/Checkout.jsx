...
export default function Checkout({ cart }) {
  ...
  const sendOrders = (cart, charge) => {
    ...
    // dispatch addOrders with deliver charge and cart items
        ...
        {/*Delivery Charge distancewise*/}
              <Box position="relative">
                ...
                <VStack
                  ...
                  <Box w="70%" pt={7}>
                    <Button onClick={() => { sendOrders(cart, last_dist); navigate('/orders') }} h={'50px'} w="full" colorScheme="red">
